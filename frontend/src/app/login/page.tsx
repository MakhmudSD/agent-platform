    ...
    <div className="min-h-screen flex items-center justify-center bg-[#F7F5F0] px-4">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center gap-2 mb-8">
          <Logo size={40} />
          <h1 className="text-lg font-semibold text-slate-900">Request Assistant</h1>
          ...
          {mode === "signup" && (
            <label className="block">
              ...
              <input
                ...
                required
                className="w-full text-sm rounded-md border border-slate-200 px-3 py-2 text-slate-900 outline-none focus:border-slate-400"
              />
            </label>
          )}
        ...
        <p className="text-center text-xs text-slate-500 mt-4">
          {mode === "login" ? (
            <>
              ...
              <button type="button" onClick={() => { setMode("signup"); setError(null); }} className="text-slate-900 font-medium underline">
                Sign up
              </button>
            </>
          ) : (
            <>
              ...
              <button type="button" onClick={() => { setMode("login"); setError(null); }} className="text-slate-900 font-medium underline">
                Sign in
              </button>
            </>
          )}
