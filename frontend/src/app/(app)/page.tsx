...
// AGENT_INFO now lives in lib/agentInfo.ts, shared with the standalone
// /help page -- same pipeline copy, one source of truth. Shown here once,
// on the empty landing state, so a first-time user knows what's actually
// happening under "Tell me what you need approved" before they've seen it
// run once; the full list is always reachable afterward via the Help rail
// item (Sidebar.tsx) for anyone who wants it again later.
